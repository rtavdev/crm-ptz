...
type InstantRulesEntityBlock<Schema extends InstantSchemaDef<any, any, any>, EntityName extends keyof Schema['entities']> = {
    bind?: string[] | Record<string, string>;
    allow: InstantRulesAllowBlock;
    fields?: {
        [AttrName in Exclude<keyof Schema['entities'][EntityName]['attrs'], 'id'>]?: string;
    };
};
export type InstantRules<Schema extends InstantSchemaDef<any, any, any> = InstantUnknownSchema> = {
    [K in 'attrs' | '$default' | '$rateLimits']?: K extends 'attrs' ? {
        ...
        bind?: string[] | Record<string, string>;
        allow: InstantRulesAllowBlock;
    } : K extends '$rateLimits' ? InstantRulesRateLimits : never;
} & {
    [K in keyof Schema['entities'] | 'attrs' | '$default' | '$rateLimits']?: K extends 'attrs' ? {
        bind?: string[] | Record<string, string>;
        allow: InstantRulesAttrsAllowBlock;
    } : K extends '$default' ? {
        bind?: string[] | Record<string, string>;
        allow: InstantRulesAllowBlock;
    } : K extends '$rateLimits' ? InstantRulesRateLimits : K extends keyof Schema['entities'] ? InstantRulesEntityBlock<Schema, K> : never;
};
export {};
//# sourceMappingURL=rulesTypes.d.ts.map