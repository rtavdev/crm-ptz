...
const makeChunkKey = (cursor, afterInclusive = false) => JSON.stringify([cursor, afterInclusive]);
...
const chunkSubKey = (direction, cursor, afterInclusive = false) => `${direction}:${makeChunkKey(cursor, afterInclusive)}`;
