...
const pgtime_ts_1 = require("./pgtime.js");
...
function pgTimezoneStrToInstant(s) {
    const match = s.match(pgtime_ts_1.pgTimezoneMatch);
    if (!match) {
        return null;
    }
    const [tz] = match;
    const offset = pgtime_ts_1.pgTimezoneAbbrevs[tz];
    const baseDate = new Date(s.replace(pgtime_ts_1.pgTimezoneMatch, 'Z'));
