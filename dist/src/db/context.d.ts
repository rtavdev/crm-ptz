 ...
 */
export declare function executeTenantQuery<T extends QueryResultRow = QueryResultRow>(tenantId: string, text: string, params?: ReadonlyArray<unknown>): Promise<QueryResult<T>>;
/**
 ...
 */
export declare function withTenantTransaction<T>(tenantId: string, fn: (client: PoolClient) => Promise<T>): Promise<T>;
